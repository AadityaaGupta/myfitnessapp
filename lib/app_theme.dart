...
import 'package:myfitnessapp/setting_enum.dart';
...
class AppTheme {
  ...
  static const Color activeDomainColor = Color.fromARGB(255, 81, 241, 94);
  ...
  AppTheme(this.colorsData) {
    ...
    if (colorsData!["page_json"].containsKey('Radius') &&
        colorsData!["page_json"]["Radius"] != null) {
    ...
    if (colorsData!["page_json"].containsKey('Height') &&
        colorsData!["page_json"]["Height"] != "") {
      // } else {
      try {
...
//general
    ...
    productGridCellColor =
        Utils.getColorFromHex(colorsData!["page_json"]["General"]["cellColor"]);
...
// //   static const Color buttonbackColor= Color(0XFF15969A);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      surface: AppTheme
          .primaryLightBackgroundColor!, //AppTheme.editTextBackgroundColor!,
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    colorScheme: ColorScheme(
      ...
      surface: AppTheme
          .primaryDarkBackgroundColor!, // AppTheme.editTextBackgroundColor!,
      onSurface: AppTheme.editTextControllerTextColor!,
    ),
    // buttonTheme: ButtonThemeData(
    //   buttonColor: AppTheme.primaryButtonBackground, // Primary button color
